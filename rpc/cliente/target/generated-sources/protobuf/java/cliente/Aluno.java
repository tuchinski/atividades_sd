...
public  final class Aluno extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cliente.Notas.internal_static_Aluno_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cliente.Notas.internal_static_Aluno_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cliente.Aluno.class, cliente.Aluno.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cliente.Aluno)) {
      return super.equals(obj);
    }
    cliente.Aluno other = (cliente.Aluno) obj;
  ...
  public static cliente.Aluno parseFrom(
  ...
  public static cliente.Aluno parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cliente.Aluno parseFrom(
  ...
  public static cliente.Aluno parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cliente.Aluno parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static cliente.Aluno parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cliente.Aluno prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using cliente.Aluno.newBuilder()
    private Builder() {
    ...
    public cliente.Aluno getDefaultInstanceForType() {
      return cliente.Aluno.getDefaultInstance();
    }

    public cliente.Aluno build() {
      cliente.Aluno result = buildPartial();
    ...
    public cliente.Aluno buildPartial() {
      cliente.Aluno result = new cliente.Aluno(this);
      result.rA_ = rA_;
      result.nome_ = nome_;
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cliente.Aluno) {
        return mergeFrom((cliente.Aluno)other);
      } else {
    ...
    public Builder mergeFrom(cliente.Aluno other) {
      if (other == cliente.Aluno.getDefaultInstance()) return this;
      if (other.getRA() != 0) {
        setRA(other.getRA());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      cliente.Aluno parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (cliente.Aluno) e.getUnfinishedMessage();
  ...
  private static final cliente.Aluno DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cliente.Aluno();
  }

  public static cliente.Aluno getDefaultInstance() {
